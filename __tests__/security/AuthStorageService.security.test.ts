...
describe('AuthStorageService Security Validation', () => {
  ...
  describe('Biometric authentication security', () => {
    it('should enable biometric authentication when available', async () => {
      // Arrange
      mockKeychainModule.getSupportedBiometryType.mockResolvedValueOnce(Keychain.BIOMETRY_TYPE.FACE_ID);
    ...
    it('should provide security configuration details', async () => {
      // Arrange
      mockKeychainModule.getSupportedBiometryType.mockResolvedValueOnce(Keychain.BIOMETRY_TYPE.TOUCH_ID);
