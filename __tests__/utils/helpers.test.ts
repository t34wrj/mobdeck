...
import { formatDate, filterArticlesByKeyword, debounce } from '../../src/utils/helpers';
...
describe('Helper Functions', () => {
  ...
  describe('filterArticlesByKeyword', () => {
    ...
    it('should handle special characters in keyword', () => {
      ...
      const filtered1 = filterArticlesByKeyword(articlesWithSpecialChars, 'C++');
      const filtered2 = filterArticlesByKeyword(articlesWithSpecialChars, '(RegEx)');
