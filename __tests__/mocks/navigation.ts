...
import { NavigationProp, RouteProp, ParamListBase, NavigationState } from '@react-navigation/native';
import * as React from 'react';

export type MockNavigationProp<T extends ParamListBase = ParamListBase> = jest.Mocked<NavigationProp<T>>;

export const createMockNavigation = <T extends ParamListBase = ParamListBase>(): MockNavigationProp<T> => ({
  navigate: jest.fn(),
  goBack: jest.fn(),
  dispatch: jest.fn(),
  setOptions: jest.fn(),
  ...
  getState: jest.fn(() => ({
    ...
    routes: [{ key: 'mock-route-key', name: 'MockScreen', params: undefined }],
    type: 'stack',
    stale: false,
    history: [],
  } as NavigationState)),
...
export type MockRouteProp<T extends ParamListBase = ParamListBase, K extends keyof T = keyof T> = jest.Mocked<RouteProp<T, K>>;

export const createMockRoute = <T extends ParamListBase = ParamListBase, K extends keyof T = keyof T>(
...
export const mockNavigationComponents = {
  ...
  createStackNavigator: jest.fn(() => ({
    ...
    Screen: ({ children }: { children: React.ReactNode }) => children as React.ReactElement,
  })),
