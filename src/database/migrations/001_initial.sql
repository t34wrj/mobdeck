...
-- Applied: 2025-06-30
-- Description: Create initial tables for articles, labels, and sync metadata

-- Enable foreign key constraints
PRAGMA foreign_keys = ON;

-- Articles table: Core article storage with offline sync support
...
-- Labels table: Article tagging system
...
-- Article-Label junction: Many-to-many relationship
...
-- Sync metadata: Track changes for server synchronization
CREATE TABLE IF NOT EXISTS sync_metadata (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    entity_type TEXT NOT NULL, -- 'article', 'label', 'article_label'
