...
export const selectIsFetchingArticles = (state: RootState) =>
  state.articles.loading.fetch;
export const selectIsCreatingArticle = (state: RootState) =>
  state.articles.loading.create;
export const selectIsUpdatingArticle = (state: RootState) =>
  state.articles.loading.update;
export const selectIsDeletingArticle = (state: RootState) =>
  state.articles.loading.delete;
export const selectIsSyncingArticles = (state: RootState) =>
  state.articles.loading.sync;
...
export const selectArticlesFetchError = (state: RootState) =>
  state.articles.error.fetch;
export const selectArticlesCreateError = (state: RootState) =>
  state.articles.error.create;
export const selectArticlesUpdateError = (state: RootState) =>
  state.articles.error.update;
export const selectArticlesDeleteError = (state: RootState) =>
  state.articles.error.delete;
export const selectArticlesSyncError = (state: RootState) =>
  state.articles.error.sync;
...
export const selectArticlesPagination = (state: RootState) =>
  state.articles.pagination;
export const selectCurrentPage = (state: RootState) =>
  state.articles.pagination.page;
export const selectPageSize = (state: RootState) =>
  state.articles.pagination.limit;
export const selectTotalPages = (state: RootState) =>
  state.articles.pagination.totalPages;
export const selectTotalArticlesCount = (state: RootState) =>
  state.articles.pagination.totalItems;
export const selectHasMoreArticles = (state: RootState) =>
  state.articles.pagination.hasMore;
...
export const selectSearchQuery = (state: RootState) =>
  state.articles.filters.searchQuery;
...
export const selectLastSyncTime = (state: RootState) =>
  state.articles.sync.lastSyncTime;
export const selectIsSyncing = (state: RootState) =>
  state.articles.sync.isSyncing;
export const selectPendingChanges = (state: RootState) =>
  state.articles.sync.pendingChanges;
export const selectSyncConflicts = (state: RootState) =>
  state.articles.sync.conflicts;
export const selectSyncError = (state: RootState) =>
  state.articles.sync.syncError;
export const selectHasPendingChanges = (state: RootState) =>
  state.articles.sync.pendingChanges.length > 0;
export const selectHasSyncConflicts = (state: RootState) =>
  state.articles.sync.conflicts.length > 0;

// Selection selectors (simplified)
export const selectSelectedArticleId = (state: RootState) =>
  state.articles.selectedArticleId;
export const selectSelectedArticle = (state: RootState) => {
  const selectedId = state.articles.selectedArticleId;
  return selectedId
    ? state.articles.articles.find(article => article.id === selectedId) || null
    : null;
};
export const selectMultiSelectMode = (state: RootState) =>
  state.articles.multiSelectMode;
export const selectSelectedArticleIds = (state: RootState) =>
  state.articles.selectedArticleIds;
export const selectSelectedArticles = (state: RootState) => {
  const selectedIds = state.articles.selectedArticleIds;
  return selectedIds
    .map(id => state.articles.articles.find(article => article.id === id))
    .filter(Boolean) as Article[];
};
export const selectSelectedArticlesCount = (state: RootState) =>
  state.articles.selectedArticleIds.length;
export const selectHasSelectedArticles = (state: RootState) =>
  state.articles.selectedArticleIds.length > 0;
...
export const selectUnreadArticles = (state: RootState) =>
  state.articles.articles.filter(
    article => !article.isRead && !article.isArchived
  );

export const selectFavoriteArticles = (state: RootState) =>
  state.articles.articles.filter(
    article => article.isFavorite && !article.isArchived
  );
...
export const selectArticlesStats = (state: RootState) => {
  ...
  return {
    ...
    unread: articles.filter(article => !article.isRead && !article.isArchived)
      .length,
...
export const selectFilteredArticlesCount = (state: RootState) =>
  selectFilteredArticles(state).length;
